<?php
    ...
    if (!$username || !$password || !$email || !$fullname || !$birthday || !$sex || !$sdt)
    {
    ...
    if (mysql_num_rows(mysql_query("SELECT tentaikhoan FROM khachhang WHERE tentaikhoan='$username'")) > 0){
    ...
    if ($addmember)
        ...
        echo "Có lỗi xảy ra trong quá trình đăng ký. <a href='reg.php'>Thử lại</a>";
?>